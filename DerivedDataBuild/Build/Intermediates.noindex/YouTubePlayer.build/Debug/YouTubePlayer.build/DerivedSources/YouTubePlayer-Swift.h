...
#ifndef YOUTUBEPLAYER_SWIFT_H
#define YOUTUBEPLAYER_SWIFT_H
...
- (void)toggleFillPlayerWindow:(NSMenuItem * _Nonnull)sender;
- (void)toggleLockAspectRatio16x9:(NSMenuItem * _Nonnull)sender;
- (void)openRecentVideoFromMenu:(NSMenuItem * _Nonnull)sender;
- (void)removeRecentVideoFromMenu:(NSMenuItem * _Nonnull)sender;
- (void)clearRecentVideosFromMenu:(NSMenuItem * _Nonnull)sender;
...
@interface YouTubeScriptMessageHandler : NSObject <WKNavigationDelegate, WKScriptMessageHandler>
